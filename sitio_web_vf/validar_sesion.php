...
include("conexion.php");
            ...
            $r= mysqli_query($conec, "SELECT * FROM usuarios WHERE nombreUsuario='$usuario' AND claveUsuario='$contraseña' AND activa='SI'  ");       
            ...
            if(!empty($q)){
                ...
                if($q["activa"]=="SI"){
                    header("location: sesion.php?id=incorrecto");
                }else{
                    header("location: sesion.php?id=incorrecto_v");
                }
            }
