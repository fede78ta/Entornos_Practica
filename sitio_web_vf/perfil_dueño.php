...
<body>
    ...
    <?php
    $s=mysqli_query($conec, "SELECT * FROM locales WHERE codUsuario='$_SESSION[codUsuario]'");
    ...
    if(!empty($usu)){
    ?>
    <h5 class="titulo">Informacion de tu local</h5>
    <p class="parrafo"><?php echo "Codigo de tu local: $usu[codLocal]"  ?></p>
    <p class="parrafo"><?php echo "Nombre de tu local: $usu[nombreLocal]"  ?></p>
    <p class="parrafo"><?php echo "Ubicacion de tu local: $usu[ubicacionLocal]"  ?></p>
    <p class="parrafo"><?php echo "Rubro de tu local: $usu[rubroLocal]"  ?></p>
    <?php
    }
    ?>
    <a class="btn btn-primary boton" role="button" href="eliminar_cuenta.php" >Eliminar Cuenta</a>
    <br>
