...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center nav nav-pills" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="incio_admin.html">Inicio</a>
                    </li>
                    <li class="nav-item">
    ...
    <h1 class="titulo_centro">Editar local local</h1>
    <form action="update_local.php" class="formulario" method="post">
        ...
        <br>
        <input type="text" name="codDueño" value="<?php echo $codDueño ?>">
