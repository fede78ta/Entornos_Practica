    ...
    <?php
        ...
        if(isset($_GET["id"]) && !empty($_GET["id"])){
            ...
            if($_GET["id"] == "incorrecto" ){
                echo "<p class='formulario'> Ya existe un usuario con ese mail. </p>";
            }elseif($_GET["id"] == "correcto_c"){
                echo "<p class='formulario'> La cuenta se ha creado correctamente dirijete a tu mail para validarla. </p>";
            }elseif($_GET["id"] == "correcto_d"){
                echo "<p class='formulario'> La cuenta se ha creado correctamente debes esperar a que el administrador la valide. </p>";
