    ...
    <p class="parrafo">Te damos la bienvenida a la pagina del shopping, en esta pagina podras canjear las promociones de nuestros locales.</p>
        ...
        ?>
            ...
            <tr>
                ...
                <td><?php echo '<a class="btn btn-primary" role="button" href="validar_dueño.php?id='.$mostrar["codUsuario"].'" name="seleccionar">Validar</a>';?></td>
                <td><?php echo '<a class="btn btn-primary" role="button" href="promociones_locales.php?id='.$mostrar["codUsuario"].'" name="seleccionar">Eliminar</a>';?></td>
            </tr>        
