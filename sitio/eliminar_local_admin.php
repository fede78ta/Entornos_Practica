...
<form action="" method="post">
    <label for="">¿Esta seguro que quiere eliminar el local?</label>
    <input type="submit" value="Si" name="borrar" class="btn btn-primary">
    <a href="locales_admin.php" class="btn btn-primary">No</a>
</form>
...
if(isset($_POST["borrar"])){
    ...
    $borrar = "DELETE FROM `locales` WHERE codigo='$codigo' ";
