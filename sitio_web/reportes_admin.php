...
<body class="color">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center nav nav-pills" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="reportes_admin.php">Reportes</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <h1 class="titulo">Reportes locales</h1>
    <p class="parrafo">En esta seccion podra ver la cantidad de uso de promociones por local.</p>
    <div class="table-responsive">
        <table class="table container">
            <thead>
                <tr>
                    ...
                    <th scope="col">Cantidad promos usadas</th>
        ...
        ?>
            ...
            <tr>
                ...
                <td><?php echo $mostrar["cantidadUso"] ?></td>
                <td><?php echo '<a class="btn btn-primary" role="button" href="reportes_promos.php?id='.$mostrar["codLocal"].'" name="seleccionar">Seleccionar</a>';?></td>
            </tr>        
