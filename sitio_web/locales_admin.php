...
<body class="color">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item active" href="locales_admin.php">Locales</a></li>
    ...
    <a class="btn btn-primary boton" href="crear_local.php" role="button">Crear local</a>
    ...
    <?php
        ...
        if(isset($_GET["edit"]) && !empty($_GET["edit"])){
            ...
            if($_GET["edit"]=="si"){
                echo "<div class='alert alert-success formulario' role='alert'>
                        El local se ha editado correctamente.
                    </div>";
            }
        }
        ...
        if(isset($_GET["eliminar"]) && !empty($_GET["eliminar"])){
            ...
            if($_GET["eliminar"]=="si"){
                echo "<div class='alert alert-success formulario' role='alert'>
                        El local se ha eliminado correctamente.
                    </div>";
            }
        } 
    ...
    <table class="table container">
        ...
        <tr>
            ...
            <td><?php echo '<a class="btn btn-primary" href="editar_local_admin.php?id='.$mostrar["codLocal"].'" role="button">Editar</a>'?></td>
            <td>
                <form action="eliminar_local.php" method="post">
                    <input type="hidden" name="codigo" value="<?php echo $mostrar['codLocal']?>">
