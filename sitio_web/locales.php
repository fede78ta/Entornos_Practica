...
<body class="color">
    ...
    <h1 class="titulo_centro">Nuestros locales</h1>
    <h2 class="titulo">Filtros de busqueda</h2>
    <form method="POST" action="locales.php">
        <div class="filtro">
        <label>Nombre:</label>
        <input type="text" name="buscarNombre">
        <label>Rubro:</label>
        <select name="buscarRubro">
    ...
    <div class="table-responsive">
        ...
        <?php
            ...
            if(isset($_POST["buscarRubro"])){
                if($_POST["buscarNombre"]=="" AND $_POST["buscarRubro"]=="Todos"){
                    $listado= "SELECT * FROM locales";
                    $r= mysqli_query($conec,$listado); 
                }
                if($_POST["buscarNombre"]=="" AND $_POST["buscarRubro"]!="Todos"){
                    $listado= "SELECT * FROM locales where rubroLocal='".$_POST["buscarRubro"]."'";
                    $r= mysqli_query($conec,$listado); 
                }
                if($_POST["buscarNombre"]!="" AND $_POST["buscarRubro"]=="Todos"){
                    $listado= "SELECT * FROM locales where nombreLocal='".$_POST["buscarNombre"]."'";
                    $r= mysqli_query($conec,$listado); 
                }
                if($_POST["buscarNombre"]!="" AND $_POST["buscarRubro"]!="Todos"){
                    $listado= "SELECT * FROM locales where nombreLocal='".$_POST["buscarNombre"]."' and rubroLocal='".$_POST["buscarRubro"]."'";
                    $r= mysqli_query($conec,$listado); 
                }
            }
        ...
        ?>
            ...
            <tr>
                ...
                <td><?php echo '<a class="btn btn-primary" role="button" href="promociones_locales.php?id='.$mostrar["codLocal"].'&pagina=1" name="seleccionar">Seleccionar</a>';?></td>
            </tr>        
