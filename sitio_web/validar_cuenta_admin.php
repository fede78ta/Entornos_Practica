...
<body class="color">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center nav nav-pills" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="validar_cuenta_admin.php">Validar Dueños</a>
                    </li>
    ...
    <p class="parrafo">Te damos la bienvenida a la pagina del shopping, en esta pagina podras canjear las promociones de nuestros locales.</p>
        ...
        if(isset($_GET["eliminar"]) && !empty($_GET["eliminar"])){
            ...
            $listado= "SELECT * FROM usuarios WHERE tipoUsuario= 'D' AND activa= 'NO' ";
            $r= mysqli_query($conec,$listado);
            $cant= mysqli_num_rows($r);
            if($cant==0){
                ?>
                <div class="alert alert-info formulario" role="alert">
                    En estos momentos no hay dueños los cuales validar.
                </div>
                <?php
            }else{
            ?>
        ...
        ?>
            ...
            <tr>
                ...
                <td><?php echo '<a class="btn btn-success" role="button" href="validar_dueño.php?id='.$mostrar["codUsuario"].'" name="seleccionar">Validar</a>';?></td>
                <td><?php echo '<a class="btn btn-danger" role="button" href="eliminar_cuenta.php?id='.$mostrar["codUsuario"].'&opc=2" name="seleccionar">Eliminar</a>';?></td>
            </tr>        
        ...
        <div class="container text-center text-md-start">
            <div class="row text-center  text-md-start"> 
                ...
                <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                    ...
                    <p>
                        <a href="mapa_admin.html">Mapa de sitio</a>
                    </p>
