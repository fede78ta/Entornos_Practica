...
<body class="color">
    ...
    <div class="table-responsive">
        ...
        <?php
            ...
            ?>
            <h1 class="titulo"><?php echo "Reporte de las promociones del local $l[nombreLocal]" ?></h1>
            <?php
        ...
        <tr>
            <td><?php echo $mostrar["codPromo"] ?></td>
            <td><?php echo $mostrar["categoriaCliente"] ?></td>
