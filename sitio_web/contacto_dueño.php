...
<body class="color">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center nav nav-pills" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="locales_dueño.php">Promociones</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="contacto_dueño.php">Contacto</a>
                    </li>
    ...
    <form class="formulario" method="post">
        ...
        <br>
        <input type="hidden" name="tipo" value="Dueño">
