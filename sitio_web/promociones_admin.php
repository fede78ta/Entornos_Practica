...
<body class="color">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" href="promociones_admin.php">Promociones</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    <p class="parrafo">En esta seccion podra aceptar o rechazar las promociones creadas por los dueños.</p>
    <?php
        $r=mysqli_query($conec, "select * from promociones where estadoPromo='Pendiente' ");
        $cant= mysqli_num_rows($r);
        if($cant==0){
            ?>
            <div class="alert alert-info formulario" role="alert">
                En estos momentos no hay promociones pendientes.
            </div>
            <?php
        }else{
        ...
        ?>  
                <div class="card text-center cuadro">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <form action="promo_aceptada.php" method="post">
                                <input type="hidden" name="codigo" value="<?php echo $mostrar['codPromo']?>">
                                <input type="submit" value="Aceptar" class="btn btn-primary">
                            </form>
                        </p>
                        <p class="card-text">
                            <form action="promo_denegada.php" method="post">
                                <input type="hidden" name="codigo" value="<?php echo $mostrar['codPromo']?>">
                                <input type="submit" value="Denegar" class="btn btn-primary">
                            </form>
                        </p>
                    </div>
