...
<body class="color">
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <?php
            ...
            switch($_SESSION["categoriaCliente"]){
                case "Inicial":
                    $busqueda=mysqli_query($conec, "select * from promociones where codLocal='$codigo' and categoriaCliente='Inicial' and estadoPromo='Aceptada' limit $inicio,$registros");
                break;
                case "Medium":
                    $busqueda=mysqli_query($conec, "select * from promociones where codLocal='$codigo' and categoriaCliente='Inicial' or categoriaCliente='Medium' and estadoPromo='Aceptada' limit $inicio,$registros");
                break;
                case "Premium":
    ...
    <ul class="pagination justify-content-center">
        ...
        <a class="page-link" href="promociones_cliente.php?id=<?php echo $codigo ?>&pagina=<?php echo $_GET['pagina']-1 ?>">Anterior</a>
        </li>
    
        <?php for($i=0;$i<$paginas;$i++): ?>
    
        <li class="page-item <?php echo $_GET['pagina']==$i+1 ? 'active' : '' ?>">
            <a class="page-link" href="promociones_cliente.php?id=<?php echo $codigo ?>&pagina=<?php echo $i+1 ?>"><?php echo $i+1 ?></a>
        </li>
    
        <?php endfor ?>

        <li class="page-item <?php echo $_GET['pagina']>=$paginas ? 'disabled' : '' ?>">
            <a class="page-link" href="promociones_cliente.php?id=<?php echo $codigo ?>&pagina=<?php echo $_GET['pagina']+1 ?>">Siguiente</a>
        </li>
    </ul>
    </nav>
