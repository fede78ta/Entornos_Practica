...
<body>
    ...
    <form class="formulario" method="post">
        ...
        <br>
        <input type="text" name="ubicacion" require>
        <br>
        <label for="">Rubro</label>
        <br>
        <input type="text" name="rubro" require>
        <br>
        <label for="">Codigo del dueño del local</label>
        <br>
        <input type="text" name="codDueño" require>
        <br>
        <br>
    ...
    $crear = "INSERT INTO `locales`(`nombreLocal`, `ubicacionLocal`, `rubroLocal`, codUsuario) VALUES ('$nombre','$ubicacion','$rubro','$codDueño')";
