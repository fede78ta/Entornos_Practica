...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center nav nav-pills" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="promociones_dueño.php">Promociones</a>
                    </li>
                    <li class="nav-item">
    ...
    <?php
        ...
        if(!empty($locales)){
        ?>
        <a class="btn btn-primary boton" href="crear_promo.php" role="button">Crear promocion</a>
        <?php
        $codLocal= $locales["codLocal"];
        $_SESSION["codLocal"]= $codLocal;
        $p=mysqli_query($conec, "select * from promociones where codLocal='$codLocal' ");
        while($promos=mysqli_fetch_assoc($p)){
    ?>
        <div class="card text-center cuadro">
            ...
            <div class="card-body">
                ...
                <form action="eliminar_promo.php" method="post">
    ...
    <?php
        ...
        ?>
        <p class="parrafo"><?php echo "No tienes un local asignado";?></p>
        <?php
    }
    ?>
