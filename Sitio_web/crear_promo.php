...
<body>
    ...
    <form class="" method="post">
        ...
        <br>
        <textarea  name="textoPromo" id="" cols="30" rows="10"></textarea>
        <br>
        <label  for="">Fecha desde</label>
        <br>
        <input  type="date" name="fechaDesdePromo" require>
        <br>
        <label  for="">Fecha hasta</label>
        <br>
        <input  type="date" name="fechaHastaPromo" require> 
        <br>
    ...
    $crear = "INSERT INTO `promociones`(`textoPromo`, `fechaDesdePromo`, `fechaHastaPromo`, `categoriaCliente`,`diasSemana` ,`estadoPromo`, `codLocal`, `cantidadUso` ) VALUES ('$textoPromo','$fechaDesdePromo','$fechaHastaPromo','$categoriaCliente','0' ,'$estadoPromo', '$codLocal', '0')";
