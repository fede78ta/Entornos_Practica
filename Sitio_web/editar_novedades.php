...
<body>
    ...
    <form action="" method="post">
        ...
        <ul class="list-group lista">
            <li class="list-group-item">
                <input class="form-check-input me-1" type="radio" name="categoriaCliente" value="Inicial" id="firstRadio">
                <label class="form-check-label" for="firstRadio">Inicial</label>
            </li>
            <li class="list-group-item">
                <input class="form-check-input me-1" type="radio" name="categoriaCliente" value="Medium" id="secondRadio" checked>
                <label class="form-check-label" for="secondRadio">Medium</label>
            </li>
            <li class="list-group-item">
                <input class="form-check-input me-1" type="radio" name="categoriaCliente" value="Premium" id="thirdRadio">
        ...
        <?php
            ...
            ?>
                ...
                <li class="list-group-item">
                    <input class="form-check-input me-1" type="radio" name="categoriaCliente" value="Premium" id="thirdRadio" checked>
                    <label class="form-check-label" for="thirdRadio">Premium</label>
                </li>
            </ul>
            <?php
